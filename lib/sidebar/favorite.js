...
const FAVORITE_ICON_PATH = '../../assets/dark_fav.svg';
const UNFAVORITE_ICON_PATH = '../../assets/dark_unfav.svg';

export function changeFavoriteState(countryName, favoriteIcon) {
  if (isCountryInFavoriteList(countryName)) {
    removeCountryFromFavorite(countryName);
    favoriteIcon.src = UNFAVORITE_ICON_PATH;
  } else {
    addCountryToFavorite(countryName);
    favoriteIcon.src = FAVORITE_ICON_PATH;
  }
}

function addCountryToFavorite(countryName) {
...
function removeCountryFromFavorite(countryName) {
  let favoritesList = JSON.parse(localStorage.getItem(FAVORITE_KEY)) || [];
...
function isCountryInFavoriteList(countryName) {
  let favoritesList = JSON.parse(localStorage.getItem(FAVORITE_KEY)) || [];
